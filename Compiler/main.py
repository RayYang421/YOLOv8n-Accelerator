...
def main():
    ...
    model_path = "/home/master_114/q36141252/AI-on-Chip/Model/best.onnx"
    ...
    text_to_hex_full("full_instructions.txt", "npu_program.hex")
    ...
    with open("cpu_runtime.py", "w", encoding="utf-8") as f:
